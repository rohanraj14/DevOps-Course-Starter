...
items=[Item('4637436473gehg', 'This is test', "2020-08-11T22:40:47.415Z", 'Done'),
                ...
                Item('sddffw54505', 'This is test4', "2020-09-23T20:40:07.565Z", 'To Do'),
...
def test_get_all_item_of_doing_list(monkeypatch):
    #Arrange 
